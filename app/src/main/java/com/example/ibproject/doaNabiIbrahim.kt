...
import kotlinx.android.synthetic.main.activity_doa_nabi_ibrahim.*
class doaNabiIbrahim : AppCompatActivity() {
    private lateinit var tmblhome : ImageButton
    private lateinit var tmblSetting : ImageButton
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_doa_nabi_ibrahim)
